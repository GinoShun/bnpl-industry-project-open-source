# Data Releases
The data has been uploaded directly to the `tables` directory.
...
## External data 
- The external data for this project is saved in the `data/external/` folder.
- `income_per_postcode.csv` which includes the information of average income per postcode by `Average taxable income or loss` and `Postcode` in that file.
- `australian_postcodes.csv` can help to transfer postcode to SA2 code
- `POA_2021_AUST_GDA2020_SHP` is the data used to draw geospatial plot based on postcode
- `SA2_2021_AUST_SHP_GDA2020` is the data used to draw geospatial plot based on SA2